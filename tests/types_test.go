...
// TestTypeForTestSuite executes the type validation tests for Schema Test Suite.
func TestTypeForTestSuite(t *testing.T) {
	testJSONSchemaTestSuiteWithFilePath(t, "../testdata/JSON-Schema-Test-Suite/tests/draft2020-12/type.json")
}

func TestSchemaWithType(t *testing.T) {
	testCases := []struct {
		name           string
		schemaJSON     string
