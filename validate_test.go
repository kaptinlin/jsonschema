...
func TestFormatValidatorsEdgeCases(t *testing.T) {
	tests := []struct {
		...
		{name: "date", validate: IsDate, valid: "2024-02-29", invalid: "2023-02-29", nonString: 42},
		...
		{name: "hostname", validate: IsHostname, valid: "example.com.", invalid: "example.-bad", nonString: 42},
		{name: "email", validate: IsEmail, valid: "user@example.com", invalid: "user@-bad.example", nonString: 42},
		{name: "idn hostname", validate: IsIDNHostname, valid: "\u5b9e\u4f8b.\u6d4b\u8bd5", invalid: "-\u5b9e\u4f8b.\u6d4b\u8bd5", nonString: 42},
		{name: "idn email", validate: IsIDNEmail, valid: "\u7528\u6237@\u5b9e\u4f8b.\u6d4b\u8bd5", invalid: "user@-\u5b9e\u4f8b.\u6d4b\u8bd5", nonString: 42},
		...
		{name: "iri", validate: IsIRI, valid: "https://\u4f8b\u5b50.\u6d4b\u8bd5/\u8def\u5f84", invalid: "\u76f8\u5bf9/\u8def\u5f84", nonString: 42},
		{name: "iri reference", validate: IsIRIReference, valid: "\u76f8\u5bf9/\u8def\u5f84", invalid: "\u76f8\u5bf9\\\\\u8def\u5f84", nonString: 42},
